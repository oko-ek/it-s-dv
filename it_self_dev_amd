...
XHR, Network browser			
UML, sequence-diagram, диаграмма последовательности		https://www.intuit.ru/studies/courses/32/32/lecture/1014?page=1	https://support.office.com/ru-ru/article/%D0%A1%D1%85%D0%B5%D0%BC%D1%8B-fa9b7a59-3099-4637-820c-1b41b24fc2a7?ui=ru-RU&rs=ru-RU&ad=RU#ID0EAABAAA=NetworkTab
RDP, SSH			
проброс портов		http://andreyolegovich.ru/PC/it-helpdesk/rdp_ssh_tunnel.php	
Putty			
...
CREATE DB sql ms server		https://docs.microsoft.com/ru-ru/sql/t-sql/statements/create-database-transact-sql?view=sql-server-2017	
SQL Server + бесплатный SQL Management Studio + лицензия SQL Server Developer для разработчика бесплатная.		https://habr.com/company/pgdayrussia/blog/329842/	
хост			
...
groovy			
симемы BI			
T-SQL работы с датами	https://www.site-do.ru/db/sql13.php		
...
docker			
ESB-шина, шлюзы	https://www.ibm.com/developerworks/ru/library/ws-enterpriseconnectivitypatterns/index.html		
