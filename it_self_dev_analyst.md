...
SQL Server + бесплатный SQL Management Studio + лицензия SQL Server Developer для разработчика бесплатная.		
...
docker			
ESB-шина, шлюзы	
https://www.ibm.com/developerworks/ru/library/ws-enterpriseconnectivitypatterns/index.html		
